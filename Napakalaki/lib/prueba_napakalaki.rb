...
module NapakalakiGame
  ...
  class PruebaNapakalaki 
    def initialize
      ...
      @@monsters << Monster.newMonster('Byakhees de bonanza', 8, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Tenochtitlan', 2, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('El sopor de Dunwich', 2, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Demonios de Magaluf', 2, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('H.P Munchcraft', 6, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Los hondos', 8, badConsequence, prize)

      # Semillas Cthulhu
      prize = Prize.new(2, 1)
      badConsequence = BadConsequence.newLevelNumberOfTreasures('Pierdes 2 niveles y 2 tesoros ' \
          'ocultos.', 2, 0, 2)
      @@monsters << Monster.newMonster('Semillas Cthulhu', 4, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Dameargo', 1, badConsequence, prize)

      # Pollipólipo volante
      prize = Prize.new(2, 1)
      badConsequence = BadConsequence.newLevelNumberOfTreasures('Da mucho asquito. Pierdes ' \
        '3 niveles.', 3, 0, 0)
      @@monsters << Monster.newMonster('Pollipólipo volante', 3, badConsequence, prize)

      # Yskhtihyssg-Goth
      prize = Prize.new(3, 1)
      badConsequence = BadConsequence.newDeath('No le hace gracia que pronuncien mal su nombre. ' \
          'Estás muerto.')
      @@monsters << Monster.newMonster('Yskhtihyssg-Goth', 14, badConsequence, prize)

      # Familia feliz
      prize = Prize.new(3, 1)
      badConsequence = BadConsequence.newDeath('La familia te atrapa. Estás muerto.')
      @@monsters << Monster.newMonster('Familia feliz', 1, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Roboggoth', 8, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('El espia sordo', 5, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Tongue', 19, badConsequence, prize)
      ...
      @@monsters << Monster.newMonster('Bicéfalo', 21, badConsequence, prize)
    end
