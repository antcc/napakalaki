...
public class Dice extends JDialog {
  ...
  private void initComponents() {
    ...
    jL_dice.setFocusable(true); // custom
  ...
  private void jL_diceMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jL_diceMouseClicked
    ...
    jB_OK.setFocusPainted(false);  // Sin focus visible
  ...
  // custom
  private void jB_buttonKeyPressed(java.awt.event.KeyEvent evt) {
      if (evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER) {
